...
const apps = [
  { name: "CivicLens", href: "/civiclens", color: "text-purple-400" },
  { name: "BallotKit", href: "/ballotkit", color: "text-blue-400" },
  { name: "RightsReady", href: "/rightsready", color: "text-emerald-400" },
  { name: "PressAgent", href: "/pressagent", color: "text-rose-400" },
  { name: "MutualAid OS", href: "/mutualaid", color: "text-amber-400" },
];
