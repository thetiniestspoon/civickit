...
import { registrationData, allStates } from '@/data/ballotkit/demo-registration';
import type { RegistrationState } from '@/data/ballotkit/demo-registration';

const navItems = [
  { label: 'My Ballot', href: '/ballotkit' },
  { label: 'Registration', href: '/ballotkit/register', active: true },
