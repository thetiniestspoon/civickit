...
import { demoRepresentatives, type RepresentativeDetail } from '@/data/civiclens/demo-representatives';
import { demoPromiseProfiles } from '@/data/civiclens/demo-promises';
...
export default function RepDetailClient({ id }: { id: string }) {
    ...
    return (
      <CivicLensShell>
        <div className="max-w-6xl mx-auto px-4 sm:px-6 py-16 text-center">
          ...
          <a href="/civiclens" className="text-violet-600 hover:text-violet-700 font-medium text-sm">
    ...
    <CivicLensShell>
      ...
      <div className="bg-white border-b border-slate-200">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 py-8">
          <a href="/civiclens/promises" className="inline-flex items-center gap-1 text-sm text-slate-400 hover:text-violet-600 mb-4">
