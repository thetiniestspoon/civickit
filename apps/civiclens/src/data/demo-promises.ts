    ...
    promises: [
      {
        ...
        sourceUrl: 'https://example.com/castillo-healthcare',
        status: 'in_progress',
      ...
      },
      {
        ...
        madeDate: 'Sep 5, 2024',
        sourceUrl: 'https://example.com/castillo-broadband',
        status: 'kept',
      ...
      },
      {
        ...
        sourceUrl: 'https://example.com/castillo-ss',
        status: 'kept',
      ...
      },
      {
        ...
        sourceUrl: 'https://example.com/castillo-education',
        status: 'no_action',
      ...
      },
      {
        ...
        category: 'Gun Safety',
        madeDate: 'Jun 3, 2024',
        sourceUrl: 'https://example.com/castillo-guns',
        status: 'in_progress',
      ...
      },
      {
        ...
        madeDate: 'Oct 1, 2024',
        sourceUrl: 'https://example.com/castillo-townhalls',
        status: 'broken',
    ...
    promises: [
      {
        ...
        sourceUrl: 'https://example.com/thornton-border',
        status: 'in_progress',
      ...
      },
      {
        ...
        sourceUrl: 'https://example.com/thornton-spending',
        status: 'broken',
      ...
      },
      {
        ...
        sourceUrl: 'https://example.com/thornton-2a',
        status: 'kept',
      ...
      },
      {
        ...
        category: 'Energy',
        madeDate: 'Sep 1, 2024',
        sourceUrl: 'https://example.com/thornton-energy',
        status: 'in_progress',
      ...
      },
      {
        ...
        category: 'Taxes',
        madeDate: 'Oct 5, 2024',
        sourceUrl: 'https://example.com/thornton-taxes',
        status: 'kept',
    ...
    promises: [
      {
        ...
        sourceUrl: 'https://example.com/okafor-manufacturing',
        status: 'in_progress',
      ...
      },
      {
        ...
        sourceUrl: 'https://example.com/okafor-water',
        status: 'kept',
      ...
      },
      {
        ...
        sourceUrl: 'https://example.com/okafor-prek',
        status: 'no_action',
      ...
      },
      {
        ...
        category: 'Immigration',
        madeDate: 'Oct 8, 2024',
        sourceUrl: 'https://example.com/okafor-immigration',
        status: 'in_progress',
      ...
      },
      {
        ...
        sourceUrl: 'https://example.com/okafor-pac',
        status: 'broken',
